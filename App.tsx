...
import { loadEntries, addEntry, deleteEntry } from './services/storage';
      ...
      <aside className="w-full md:w-64 bg-white border-r border-gray-200 md:h-screen sticky top-0 z-10">
        ...
        <nav className="p-4 space-y-2">
          <button
            ...
            className={`w-full flex items-center gap-3 px-4 py-3 text-sm font-medium rounded-lg transition-colors ${currentView === ViewState.LOG_TIME
          ...
          <button
            onClick={() => setCurrentView(ViewState.HISTORY)}
            className={`w-full flex items-center gap-3 px-4 py-3 text-sm font-medium rounded-lg transition-colors ${currentView === ViewState.HISTORY
              ? 'bg-indigo-50 text-indigo-700'
              : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900'
              }`}
          >
          ...
          <button
            ...
            className={`w-full flex items-center gap-3 px-4 py-3 text-sm font-medium rounded-lg transition-colors ${currentView === ViewState.REPORTS
              ? 'bg-indigo-50 text-indigo-700'
              : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900'
              }`}
          >
